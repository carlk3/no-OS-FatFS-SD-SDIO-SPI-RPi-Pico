...
There should be one element of the sdio_ifs[] array for each SDIO interface.

There should be one element of the sd_cards[] array for each SD card socket.
* Each element of sd_cards[] must point to its interface with sdio_if_p.
